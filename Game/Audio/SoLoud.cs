...
#error Unknown platform
    ...
    public class Monotone : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int Monotone_load(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
    ...
    public class Openmpt : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int Openmpt_load(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
        public int load(string aFilename)
        {
    ...
    public class Sfxr : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int Sfxr_loadParams(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
    ...
    public class Speech : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int Speech_setText(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aText);
    ...
    public class TedSid : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int TedSid_load(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
        public int load(string aFilename)
        {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int TedSid_loadToMem(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
    ...
    public class Vizsn : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern void Vizsn_setText(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aText);
    ...
    public class Wav : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int Wav_load(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
        public int load(string aFilename)
        {
    ...
    public class WavStream : SoloudObject
    {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int WavStream_load(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
        public int load(string aFilename)
        {
        ...
        [DllImport(SoLoud.libpath, CallingConvention = CallingConvention.Cdecl)]
        internal static extern int WavStream_loadToMem(IntPtr aObjHandle, [MarshalAs(UnmanagedType.LPWStr)] string aFilename);
        public int loadToMem(string aFilename)
        {
